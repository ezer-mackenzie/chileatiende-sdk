"""Asynchronous client for ChileAtiende API endpoints."""
...
class AsyncChileAtiendeClient:
    """Asynchronous HTTP client for ChileAtiende API."""
    ...
    async def list_fichas(
        ...
        *,
        ...
        """List procedures/sheets (Fichas) asynchronously with optional search query and pagination."""
        ...
        payload = await self._request("fichas", params=params)
    ...
    async def list_fichas_by_servicio(
        ...
        *,
        ...
        """List procedures/sheets (Fichas) offered by a specific public service asynchronously."""
        ...
        payload = await self._request(f"servicios/{servicio_id_clean}/fichas", params=params)
        if "fichas" in payload:
            return ResponseParser.parse_model(FichasFeedEnvelope, payload).fichas
        return ResponseParser.parse_model(FichasFeed, payload)
    ...
    async def list_servicios(self) -> ServiciosFeed:
        ...
        payload = await self._request("servicios")
    ...
    async def get_sucursal(self, sucursal_id: str) -> Sucursal:
        """Obtain detailed information for a single branch office (Sucursal) asynchronously."""
    ...
    async def list_sucursales(self, *, mobile_offices: bool | None = None) -> SucursalesFeed:
        ...
        payload = await self._request("sucursales", params=params)
